        ...
        <div className=" w-full grid grid-cols-1 lg:grid-cols-2 items-center ">
          ...
          >
            ...
            <h1 className="text-[22px] sm:text-2xl md:text-[28px] xl:text-[32px] 2xl:text-[38px] leading-[38px] lg:leading-[44px] text-lightBlack dark:text-white font-semibold">
             Corum8 Mansion – The Best Luxury Villa in Udaipur

            </h1>
            <p className="text-sm sm:text-base font-Lora text-gray dark:text-lightGray font-normal leading-[26px]">
              Whether you’re planning a Business parties, anniversary, birthday party, photoshoot,
honeymoon, or corporate retreat, Corum8 Mansion offers the perfect backdrop for every
occasion
            </p>
          ...
          >
            <img
              src="https://a0.muscache.com/im/pictures/hosting/Hosting-1544385860919253271/original/726184f1-7c88-4245-9118-b22f1cfea190.jpeg?im_w=1200"
