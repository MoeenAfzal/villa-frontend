...
const RoomDetails4BHK = () => {
  ...
  try {
    ...
    return (
        <section className="">
            <BreadCrumb img="/images/photos/bed3.jpg" title="room details" />
            ...
            <div className="py-20 2xl:py-[120px] dark:bg-lightBlack">
                    ...
                    <div className="col-span-6 md:col-span-4">
                        ...
                        <div className="pt-5 lg:pt-[35px]  pr-3">
                            ...
                            <h2
                                ...
                                data-aos-duration="1000"
                            >
                                4 BHK Luxury Stay at Corum8 Venue

                            </h2>


                            <p className="text-gray my-2"><strong>Comfortably Accommodates Up to 12 Guests</strong> </p>
                            <p className="text-gray my-2"><strong>Spacious, Private & Perfect for Large Groups</strong> </p>
                            <p
                                className="text-sm lg:text-base leading-6 text-gray dark:text-lightGray font-normal font-Lora"
                                data-aos="zoom-in-up"
                                data-aos-duration="1000"
                            >
                                Our 4 BHK accommodation at Corum8 Venue is designed for guests who require ample space, privacy, and premium comfort. Ideal for large families, group travelers, corporate teams, and event guests, this unit offers a seamless blend of luxury and functionality for a memorable stay.
                            </p>
                ...
                font-Garamond text-[22px] sm:text-2xl md:text-3xl 2xl:text-[32px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                                >
                                    4 Bedrooms | Capacity: Up to 12 People
                                </h2>
    ...
    font-Garamond text-[22px] sm:text-2xl md:text-2xl 2xl:text-[22px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                                ...
                                <ul className="space-y-2 lg:space-y-3">
                                    ...
                                    <li className="flex items-center">
                                        <BsCheck2 size={16} className="text-khaki mr-2" />
                                        <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                                            Peaceful ambiance for restful sleep
                                        </span>
                                    </li>
                                </ul>
                            </div>
    ...
    font-Garamond text-[22px] sm:text-2xl md:text-2xl 2xl:text-[22px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                                ...
                                <ul className="space-y-2 lg:space-y-3">
                                    <li className="flex items-center">
                                        <BsCheck2 size={16} className="text-khaki mr-2" />
                                        <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                                            Expansive living room with comfortable seating
                                        </span>
                                    </li>
                                    ...
                                    <li className="flex items-center">
                                        <BsCheck2 size={16} className="text-khaki mr-2" />
                                        <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                                            Dedicated dining space suitable for group meals
                                        </span>
                                    </li>
                                    ...
                                    <li className="flex items-center">
                                        <BsCheck2 size={16} className="text-khaki mr-2" />
                                        <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                                            Ideal for relaxation, conversations, or informal meetings
                                        </span>
                                    </li>
                                </ul>
                            </div>
    ...
    font-Garamond text-[22px] sm:text-2xl md:text-2xl 2xl:text-[22px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                                ...
                                <ul className="space-y-2 lg:space-y-3">
                                    <li className="flex items-center">
                                        <BsCheck2 size={16} className="text-khaki mr-2" />
                                        <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                                            Large families and group stays (up to 12 guests)
                                        </span>
                                    </li>
                                    ...
                                    <li className="flex items-center">
                                        <BsCheck2 size={16} className="text-khaki mr-2" />
                                        <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                                            Corporate teams & offsite accommodations
                                        </span>
                                    </li>
                ...
                font-Garamond text-[22px] sm:text-2xl md:text-3xl 2xl:text-[32px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                                ...
                                <p className="text-sm lg:text-base leading-6 text-gray dark:text-lightGray font-normal font-Lora">
                                    The 4 BHK at Corum8 Venue ensures everyone enjoys privacy while staying connected in a spacious, home-style environment. Whether your visit is for business, celebration, or leisure, this is a stay designed to accommodate everyone comfortably.
                                </p>
                            </div>
                        </div>
                    </div>
...
export default RoomDetails4BHK;
