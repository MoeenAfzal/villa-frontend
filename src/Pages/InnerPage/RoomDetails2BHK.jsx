...
const confirmBooking = async () => {
  ...
  return (
    <section className="">
      <BreadCrumb img={"/images/photos/bed1.jpg"} title="room details" />
          ...
          <div className="col-span-6 md:col-span-4">
            ...
            <div className="pt-5 lg:pt-[35px]  pr-3">
              ...
              <h2
                ...
                data-aos-duration="1000"
              >
                2 BHK Luxury Stay at Corum8 Venue

              </h2>
              <p className="text-gray my-4"><strong>Comfort, Privacy & Space — Designed for Premium Living</strong>
              </p>
              <p
                ...
                data-aos-duration="1000"
              >
                Our 2 BHK accommodation at Corum8 Venue is thoughtfully designed for guests who value space, comfort, and a refined living experience. Ideal for families, business travelers, long-stay guests, and small groups, this unit blends modern interiors with peaceful surroundings to ensure a relaxing and productive stay.
                ...
                <ul className="space-y-2 lg:space-y-3 ">
                  <li className="flex items-center">
                    ...
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Spacious, well-lit bedrooms with comfortable beds
                    </span>
                  </li>
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Premium mattresses and fresh linens
                  ...
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Wardrobes and side tables for convenience
                    </span>
                  </li>
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Calm, noise-free environment for quality rest
                    </span>
                  </li>
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Capacity of 2 BHK is upto 6 persons
                    </span>
                  </li>
                </ul>
              </div>
              ...
              >
                ...
                <ul className="space-y-2 lg:space-y-3 ">
                  ...
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Perfect for relaxing, informal meetings, or family time
                    </span>
                  </li>
              ...
              >
                ...
                <ul className="space-y-2 lg:space-y-3 ">
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Clean, well-maintained attached bathrooms
                    </span>
                  </li>
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                  ...
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Quality fittings and toiletries
                    </span>
                  </li>
    ...
    font-Garamond text-[22px] sm:text-2xl md:text-2xl 2xl:text-[22px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                ...
                <ul className="space-y-2 lg:space-y-3">
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Functional kitchen or pantry space
                    </span>
                  </li>
                  ...
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Ideal for light cooking or long stays
                    </span>
                  </li>
                </ul>
              </div>
    ...
    font-Garamond text-[22px] sm:text-2xl md:text-2xl 2xl:text-[22px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                ...
                <ul className="space-y-2 lg:space-y-3">
                  ...
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      On-call assistance during stay
                    </span>
                  </li>
                </ul>
              </div>
    ...
    font-Garamond text-[22px] sm:text-2xl md:text-2xl 2xl:text-[22px] leading-7 lg:leading-[26px] text-lightBlack dark:text-white font-semibold"
                ...
                <ul className="space-y-2 lg:space-y-3">
                  ...
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Corporate travelers & consultants
                    </span>
                  </li>
                  ...
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Event attendees staying overnight
                    </span>
                  </li>
                  ...
                  <li className="flex items-center">
                    <BsCheck2 size={16} className="text-khaki mr-2" />
                    <span className="text-sm lg:text-base leading-[26px] text-gray dark:text-lightGray font-normal font-Lora">
                      Couples seeking privacy & comfort
                    </span>
                  </li>
                </ul>
              </div>
...
export default RoomDetails2BHK;
