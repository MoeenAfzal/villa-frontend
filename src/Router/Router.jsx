...
import RoomDetails from "../Pages/InnerPage/RoomDetails2BHK";
import RoomDetails2BHK from "../Pages/InnerPage/RoomDetails2BHK";
import RoomDetails3BHK from "../Pages/InnerPage/RoomDetails3BHK";
import RoomDetails4BHK from "../Pages/InnerPage/RoomDetails4BHK";
...
import PaymentSuccess from "../Pages/InnerPage/PaymentSuccess";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "/2bhk-room-detail",
        element: <RoomDetails2BHK />,
      },
       {
        path: "/3bhk-room-detail",
        element: <RoomDetails3BHK />,
      },
       {
        path: "4bhk-room-detail",
        element: <RoomDetails4BHK />,
      },
       {
        path: "/room_details",
        element: <RoomDetails />,
