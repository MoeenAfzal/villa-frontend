...
const Navbar = () => {
  ...
  return (
    <nav
      className={`mk w-full lg:fixed font-Lora   lg:px-5 lg:py-2  transition-all duration-300 ${navbarBgColor} `}
    >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="px-3 w-full lg:hidden flex justify-between text-lightBlack lg:text-white dark:text-white bg-khaki h-[70px]  items-center  p-3">
            <div className=" w-28  ">
              <Link to="/">
                <img
                  src="/images/photos/whitelogo.png"
                  className="block lg:hidden "
                  alt="Corum8_website_logo"
                />
              </Link>
            </div>
          ...
          >
            ...
            <a
              href="#offers"
              className="text-lightBlack lg:text-white dark:text-white lg:border-b-0 px-3 py-2 w-full block transition-all duration-300"
            >
              Services
            </a>
